...
public class TunaAnimations {
    public class tunaAnimation {
        public static final AnimationDefinition ANIM_TUNA_SWIM = AnimationDefinition.Builder.withLength(0.5F).looping()
                .addAnimation("body_left", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                ...
                .addAnimation("body_right", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 3.75F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
        ...
        public static final AnimationDefinition ANIM_TUNA_FLOP = AnimationDefinition.Builder.withLength(0.5F).looping()
