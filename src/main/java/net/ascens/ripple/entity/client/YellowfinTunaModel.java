...
public class YellowfinTunaModel<T extends YellowfinTunaEntity> extends HierarchicalModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Ripple.MOD_ID, "yellowfin_tuna"), "main");
    ...
    public YellowfinTunaModel(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition head_right = head_left.addOrReplaceChild("head_right", CubeListBuilder.create().texOffs(0, 35).addBox(0.0F, -2.5F, -5.0F, 5.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, 0.0F, 0.0F));

        PartDefinition body_left = root2.addOrReplaceChild("body_left", CubeListBuilder.create(), PartPose.offset(2.5F, 0.0F, 5.0F));

        PartDefinition body_right = body_left.addOrReplaceChild("body_right", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -3.5F, 0.0F, 7.0F, 8.0F, 13.0F, new CubeDeformation(0.0F))
                .texOffs(0, 8).addBox(2.5F, -6.5F, 2.0F, 0.0F, 3.0F, 13.0F, new CubeDeformation(0.0F))
                .texOffs(40, 8).addBox(5.0F, 4.5F, 2.0F, 0.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(34, 40).addBox(0.0F, 4.5F, 2.0F, 0.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(40, 0).addBox(2.5F, 4.5F, 9.0F, 0.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, 0.0F, 0.0F));

        PartDefinition left_fin = body_right.addOrReplaceChild("left_fin", CubeListBuilder.create().texOffs(38, 30).addBox(0.0F, -1.5F, 0.0F, 0.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(6.0F, 0.0F, 2.0F));

        PartDefinition right_fin = body_right.addOrReplaceChild("right_fin", CubeListBuilder.create().texOffs(20, 39).addBox(0.0F, -1.5F, 0.0F, 0.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 0.0F, 2.0F));
        ...
        PartDefinition back_fin_right = back_fin_left.addOrReplaceChild("back_fin_right", CubeListBuilder.create().texOffs(38, 21).addBox(0.5F, -1.5F, 0.0F, 4.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
                .texOffs(22, 21).addBox(2.5F, -4.5F, 5.0F, 0.0F, 10.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, 0.0F, 0.0F));

        return LayerDefinition.create(meshdefinition, 64, 64);
    }

    @Override
    public void setupAnim(@NotNull YellowfinTunaEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
